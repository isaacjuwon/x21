        ...
        <x-ui.card>
            <form wire:submit="save" class="space-y-6">
                <x-ui.field>
                    ...
                    <x-ui.input wire:model="subject" id="subject" placeholder="Briefly describe your issue" />
                    <x-ui.error name="subject" />
                </x-ui.field>

                <x-ui.field>
                    <x-ui.label for="priority">Priority</x-ui.label>
                    <x-ui.select wire:model="priority" id="priority">
                ...
                <x-ui.field>
                    ...
                    <x-ui.textarea wire:model="message" id="message" rows="5" placeholder="Describe the issue in detail..." />
                    <x-ui.error name="message" />
                </x-ui.field>

                <div class="flex justify-end gap-3">
                    <x-ui.button type="button" variant="ghost" wire:navigate href="{{ route('tickets.index') }}">Cancel</x-ui.button>
