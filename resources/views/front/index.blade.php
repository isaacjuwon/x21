                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div class="flex items-center gap-6">
                         @if($layoutSettings->facebook)
                            <a href="{{ $layoutSettings->facebook }}" class="text-foreground-content hover:text-primary transition-colors">
                                <x-ui.icon name="ps:facebook-logo" class="size-5" />
                            </a>
                        @endif
                        @if($layoutSettings->twitter)
                            <a href="{{ $layoutSettings->twitter }}" class="text-foreground-content hover:text-primary transition-colors">
