...
new class extends Component
{
    ...
    public function mount(LoanLevel $loanLevel)
    {
        $this->loanLevel = $loanLevel;
        $this->name = $loanLevel->name;
        $this->slug = $loanLevel->slug;
        $this->maximum_loan_amount = $loanLevel->maximum_loan_amount;
        $this->installment_period_months = $loanLevel->installment_period_months;
        $this->interest_rate = $loanLevel->interest_rate;
        $this->is_active = $loanLevel->is_active;
    }
    ...
    public function save()
    {
        $validated = $this->validate([
            ...
            'slug' => 'required|string|max:255|unique:loan_levels,slug,'.$this->loanLevel->id,
        ...
        $this->loanLevel->update($validated);

        $this->toastSuccess('Loan level updated successfully.');
