...
new class extends Component
{
    ...
    public function mount(DataPlan $plan)
    {
        $this->plan = $plan;
        $this->name = $plan->name;
    ...
    public function save()
    {
        ...
        $this->toastSuccess('Data plan updated successfully.');
    }

    public function delete()
    {
        $this->plan->delete();
        $this->toastSuccess('Data plan deleted successfully.');
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-[--radius-box] shadow-sm border border-neutral-100 dark:border-neutral-700 p-6">
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <x-ui.field>
                    <x-ui.label for="brand_id">Network</x-ui.label>
