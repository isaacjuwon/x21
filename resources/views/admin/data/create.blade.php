...
new class extends Component
{
    ...
    public function save()
    {
        ...
        $this->toastSuccess('Data plan created successfully.');
...
<div class="max-w-2xl mx-auto p-6 space-y-6">
    <x-page-header 
        heading="Create Data Plan" 
        description="Add a new data package"
    >
        <x-slot:actions>
            <x-ui.button tag="a" href="{{ route('admin.data.index') }}" variant="outline">
                Cancel
            </x-ui.button>
        </x-slot:actions>
    </x-page-header>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <form wire:submit="save" class="space-y-6">
            <x-ui.field>
                ...
                <x-ui.input wire:model="name" id="name" placeholder="e.g., 1GB Monthly" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <x-ui.field>
                    ...
                    <x-ui.input wire:model="type" id="type" placeholder="e.g., SME, Gifting" />
            ...
            <x-ui.field>
                ...
                <x-ui.input wire:model="api_code" id="api_code" placeholder="e.g., mtn-1gb-sme" />
