...
new class extends Component
{
    ...
    public function mount(EducationPlan $plan)
    {
        $this->plan = $plan;
        $this->name = $plan->name;
    ...
    public function save()
    {
        ...
        $this->toastSuccess('Education plan updated successfully.');
    }

    public function delete()
    {
        $this->plan->delete();
        $this->toastSuccess('Education plan deleted successfully.');
