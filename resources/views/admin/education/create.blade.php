...
new class extends Component
{
    ...
    public function save()
    {
        ...
        $this->toastSuccess('Education plan created successfully.');
...
<div class="max-w-2xl mx-auto p-6 space-y-6">
    <x-page-header 
        heading="Create Education Plan" 
        description="Add a new exam pin package"
    >
        <x-slot:actions>
            <x-ui.button tag="a" href="{{ route('admin.education.index') }}" variant="outline">
                Cancel
            </x-ui.button>
        </x-slot:actions>
    </x-page-header>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <form wire:submit="save" class="space-y-6">
            <x-ui.field>
                ...
                <x-ui.input wire:model="name" id="name" placeholder="e.g., WAEC Result Checker" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <x-ui.field>
                    <x-ui.label for="provider">Provider</x-ui.label>
                    <x-ui.select wire:model="brand_id" id="provider">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <x-ui.field>
                    ...
                    <x-ui.input wire:model="type" id="type" placeholder="e.g., Result Checker, Registration" />
                    <x-ui.error name="type" />
                </x-ui.field>

                <x-ui.field>
                    <x-ui.label for="duration">Duration</x-ui.label>
                    <x-ui.input wire:model="duration" id="duration" placeholder="e.g., 1 year" />
            ...
            <x-ui.field>
                ...
                <x-ui.input wire:model="api_code" id="api_code" placeholder="e.g., waec-result" />
