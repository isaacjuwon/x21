...
new class extends Component
{
    ...
    public function save()
    {
        ...
        $this->toastSuccess('Electricity plan created successfully.');
...
<div class="max-w-2xl mx-auto p-6 space-y-6">
    <x-page-header 
        heading="Create Electricity Plan" 
        description="Add a new electricity provider"
    >
        <x-slot:actions>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <form wire:submit="save" class="space-y-6">
            <x-ui.field>
                ...
                <x-ui.input wire:model="name" id="name" placeholder="e.g., IKEDC Prepaid" />
            ...
            <x-ui.field>
                ...
                <x-ui.input wire:model="api_code" id="api_code" placeholder="e.g., ikedc-prepaid" />
