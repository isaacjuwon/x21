...
<div class="max-w-7xl mx-auto p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Airtime Plans</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage airtime packages</p>
        </div>
