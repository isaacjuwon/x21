...
new class extends Component
{
    ...
    public function delete(AirtimePlan $plan)
    {
        $plan->delete();
...
<div class="max-w-7xl mx-auto p-6 space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-neutral-900 dark:text-white">Airtime Plans</h1>
            <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Manage airtime packages</p>
        </div>
        <x-ui.button icon="plus" tag="a" href="{{ route('admin.airtime.create') }}" variant="primary">
            New Plan
        </x-ui.button>
    </div>
                        ...
                        <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <x-ui.button tag="a" href="{{ route('admin.airtime.view', $plan) }}" variant="ghost" size="sm">
                                        View
                                    </x-ui.button>
                                    <x-ui.button 
