...
new class extends Component
{
    ...
    public function mount(AirtimePlan $plan)
    {
        $this->plan = $plan;
        $this->name = $plan->name;
    ...
    public function save()
    {
        ...
        $this->toastSuccess('Airtime plan updated successfully.');
    }

    public function delete()
    {
        $this->plan->delete();
        $this->toastSuccess('Airtime plan deleted successfully.');
